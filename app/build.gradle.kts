...
import com.tpp.generatebp.GenerateBpPlugin
import com.tpp.generatebp.GenerateBpPluginExtension
import com.tpp.generatebp.models.Module
...
buildscript {
    ...
    dependencies {
        classpath("com.tpp:gradle-generatebp:+")
    }
}
