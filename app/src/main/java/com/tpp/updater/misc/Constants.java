...
public final class Constants {
    ...
    public static final String PROP_VERSION = "org.pixelproject.base.version";
    public static final String PROP_DEVICE = "ro.build.product";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "tpp.updater.allow_downgrading";
