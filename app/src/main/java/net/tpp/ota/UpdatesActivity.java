...
import static net.tpp.ota.model.UpdateStatus.UNKNOWN;
...
import net.tpp.ota.ExtrasFragment.UpdateListener;
import net.tpp.ota.controller.ABUpdateInstaller;
import net.tpp.ota.controller.UpdaterController;
import net.tpp.ota.controller.UpdaterService;
import net.tpp.ota.download.DownloadClient;
import net.tpp.ota.misc.Constants;
import net.tpp.ota.misc.Utils;
import net.tpp.ota.model.UpdateInfo;
import net.tpp.ota.model.UpdateStatus;
import net.tpp.ota.model.Update;
