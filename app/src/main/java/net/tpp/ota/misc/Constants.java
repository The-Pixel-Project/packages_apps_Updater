...
public final class Constants {
    ...
    static final String PROP_DEVICE = "org.pixelproject.device";
    static final String PROP_BUILD_VERSION = "org.pixelproject.base.version";
    static final String OTA_URL = "https://raw.githubusercontent.com/The-Pixel-Project/official_devices/%s/devices/%s.json";
    static final String MAINTAINER_URL = "https://github.com/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://github.com/The-Pixel-Project/official_devices/blob/fourteen/changelogs/source.md#latest";
